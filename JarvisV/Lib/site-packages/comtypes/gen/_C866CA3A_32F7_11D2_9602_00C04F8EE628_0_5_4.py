...
__all__ = [
    'SECHighConfidence', 'SAFTCCITT_ALaw_22kHzStereo',
    'SVSFNLPSpeakPunc', 'SVSFParseAutodetect', 'SPPHRASERULE',
    'SPSEMANTICERRORINFO', 'DISPID_SAFGuid',
    'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_PRIVATE6', 'SP_VISEME_3',
    'SP_VISEME_4', 'SREPropertyStringChange', 'SPEI_RESERVED6',
    'SPRST_INACTIVE', 'SpeechUserTraining', 'ISpeechXMLRecoResult',
    'DISPID_SpeechGrammarRule', 'SRSActiveAlways',
    'DISPID_SRCEAudioLevel', 'SPRST_ACTIVE', 'SVEStartInputStream',
    'SPRST_NUM_STATES', 'DISPID_SpeechRecoResult2',
    'SWPUnknownWordUnpronounceable',
    'SpeechPropertyComplexResponseSpeed', 'SVSFNLPMask',
    'SP_VISEME_13', 'DISPID_SRCEAdaptation', 'DISPID_SPRuleChildren',
    'SPGS_DISABLED', 'SRTReSent', 'DISPID_SCSBaseStream',
    'DISPID_SVSLastBookmark', 'SAFTADPCM_8kHzMono',
    'SVSFPurgeBeforeSpeak', 'DISPID_SLPLangId', 'SPCS_ENABLED',
    'SRCS_Enabled', 'SPSHORTCUTTYPE', 'DISPID_SRDisplayUI',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRsCommit',
    'SGLexical', 'SPFILEMODE', 'SAFT44kHz8BitStereo', 'SRAExport',
    'SPVPRIORITY', 'DISPIDSPTSI_ActiveLength', 'SRTStandard',
    'SVSFlagsAsync', 'DISPID_SRRTTickCount',
    'DISPID_SVSCurrentStreamNumber', 'SAFT48kHz16BitMono',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_19', 'SVP_0',
    'DISPID_SABIEventBias', 'SpeechVoiceSpeakFlags', 'SPLOADOPTIONS',
    'ISpeechRecoContext', 'DISPID_SRRAudioFormat',
    'DISPID_SRGCmdLoadFromFile', 'SPSHORTCUTPAIR', 'SPWT_DISPLAY',
    'SpeechRecoEvents', 'SPEI_VOICE_CHANGE', 'SpeechPartOfSpeech',
    'SpeechRegistryUserRoot', 'DISPID_SPRulesCount', 'SDTRule',
    'SpeechCategoryRecoProfiles', 'ISpNotifyTranslator', 'SVP_14',
    'SpeechTokenShellFolder', 'SVEAllEvents', 'SECFIgnoreKanaType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_REQUEST_UI',
    'SAFTNoAssignedFormat', 'SpTextSelectionInformation',
    'DISPID_SOTGetAttribute', 'SpShortcut', 'DISPID_SPRuleParent',
    'LONG_PTR', 'SDTPronunciation',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechAudioFormatType', 'DISPID_SRGDictationUnload',
    'SPVPRI_NORMAL', 'ISpRecognizer', 'DISPID_SpeechRecoContext',
    'SPEI_RECO_STATE_CHANGE', 'SAFTCCITT_ALaw_11kHzStereo',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_PRIVATE4', 'SPFM_CREATE',
    'SPRULE', 'SRAInterpreter', 'DISPID_SpeechVoiceEvent',
    'SPEI_MIN_SR', 'DISPID_SPEAudioSizeBytes', 'DISPID_SVSVisemeId',
    'DISPID_SVSpeakStream', 'SPGS_ENABLED',
    'DISPID_SVSInputWordPosition', 'SWPKnownWordPronounceable',
    'SpeechGrammarTagDictation', 'SPEI_START_INPUT_STREAM',
    'ISpRecoGrammar', 'SVSFParseSapi', 'SpeechSpecialTransitionType',
    'DISPID_SVSLastResult', 'SVP_3', 'SPPS_Noun',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_PRIVATE2', 'SVP_17',
    'SPPS_Function', 'SpeechLoadOption', 'DISPID_SRCResume',
    'SpeechVoicePriority', 'SpeechVoiceSkipTypeSentence',
    'SpeechAllElements', 'SPEI_START_SR_STREAM',
    'SpeechEngineProperties', 'SSSPTRelativeToEnd',
    'DISPID_SGRSAddRuleTransition', 'SAFTDefault',
    'SPFM_OPEN_READWRITE', 'DISPID_SRRGetXMLResult',
    'DISPID_SLWs_NewEnum', 'SPEI_MAX_SR', 'SDA_No_Trailing_Space',
    'DISPID_SRRTimes', 'DISPID_SVDisplayUI', 'DISPID_SLWsCount',
    'SASClosed', 'SRSInactiveWithPurge', 'DISPID_SVEBookmark',
    'ISpeechPhraseElements', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLWType', 'DISPID_SADefaultFormat', 'SREAudioLevel',
    'DISPID_SVAlertBoundary', 'SITooSlow', 'SRERequestUI',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGetRecognizers',
    'DISPID_SDKSetLongValue', 'ISpeechGrammarRules',
    'DISPID_SPIElements', 'DISPID_SPRuleName',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPLO_STATIC',
    'SPEI_ADAPTATION', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPANumberOfElementsInResult', 'ISpResourceManager',
    'SPRECOGNIZERSTATUS', 'SECLowConfidence', 'SP_VISEME_16',
    'ISpSerializeState', 'DISPID_SOTCDefault',
    'SPEI_SR_RETAINEDAUDIO', 'SPBO_TIME_UNITS',
    'SSSPTRelativeToCurrentPosition', 'SAFT11kHz8BitMono',
    'DISPID_SPEActualConfidence', 'SLTApp', 'SAFTExtendedAudioFormat',
    'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE12', 'SVP_8', 'SFTSREngine',
    'DISPID_SGRAddState', 'SPPS_SuppressWord', 'SPWT_LEXICAL',
    'SPEI_RESERVED1', 'SPPS_RESERVED3', 'SVP_13', 'SpResourceManager',
    'DISPID_SRCState', 'SpeechTokenIdUserLexicon',
    ...
    'SPRECOSTATE', 'SpeechRuleAttributes', 'ISpeechAudioBufferInfo',
    'SPSERIALIZEDRESULT', 'SVESentenceBoundary',
    'DISPIDSPTSI_ActiveOffset', 'SAFT44kHz8BitMono', 'ISpEventSource',
    'SAFTCCITT_ALaw_44kHzMono', 'SpUnCompressedLexicon',
    'SAFTGSM610_8kHzMono', 'DISPID_SOTsCount', 'SpeechVoiceEvents',
    'SAFTGSM610_11kHzMono', 'DISPID_SPAsCount',
    'DISPID_SDKGetStringValue', 'SPPS_Verb', 'SpInprocRecognizer',
    'SpNotifyTranslator', 'DISPID_SRGRules', 'DISPID_SMSAMMHandle',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechCustomStream',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRRSaveToMemory',
    'SPPS_NotOverriden', 'ISpeechVoice',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SDKOpenKey',
    'DISPID_SOTCSetId', 'DISPID_SPIGetText', 'SPWF_INPUT',
    'DISPID_SpeechDataKey', 'SpeechCategoryPhoneConverters',
    'DISPID_SVSInputSentenceLength', 'SREBookmark', 'DISPID_SOTCId',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechPhraseRules',
    'DISPID_SDKSetBinaryValue', 'SRCS_Disabled', 'SGRSTTWildcard',
    'SPSHT_OTHER', 'SAFTGSM610_22kHzMono', 'ISpeechMemoryStream',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SAFType', 'DISPID_SRCPause', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpProperties', 'SBONone', 'DISPID_SLGenerationId',
    'DISPID_SRRPhraseInfo', 'STSF_FlagCreate', 'ISpeechVoiceStatus',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SDKCreateKey',
    'DISPID_SpeechVoice', 'DISPID_SGRSTRule', 'SVEVoiceChange',
    'DISPID_SRCEBookmark', 'DISPID_SpeechPhoneConverter',
    'SpeechRetainedAudioOptions', 'SP_VISEME_8', 'ISpEventSink',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRIsUISupported',
    'ISpeechLexicon', 'SpFileStream', 'SpeechEngineConfidence',
    'SRTAutopause', 'SRADefaultToActive', 'SpLexicon',
    'SPINTERFERENCE', 'SPWAVEFORMATTYPE', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVEStreamEnd', 'SGLexicalNoSpecialChars', 'SVSFParseSsml',
    'DISPID_SRRTStreamTime', 'DISPID_SVEStreamStart',
    'DISPID_SRGetPropertyString', 'SREPropertyNumChange',
    'SAFT32kHz16BitStereo', 'DISPID_SPRuleEngineConfidence',
    'SpeechInterference', 'DISPID_SLGetWords',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpPhoneConverter',
    'SP_VISEME_11', 'SAFT24kHz8BitMono', 'SRSEDone',
    'SPEI_SR_BOOKMARK', 'SpeechRecognitionType', 'ISpShortcut',
    'SPAO_RETAIN_AUDIO', 'SAFTText', 'DISPID_SPRulesItem',
    'DISPID_SABufferNotifySize', 'STCInprocServer', 'SPAR_Low',
    'SPAR_Medium', 'SpObjectToken', 'DISPID_SRCBookmark',
    'DISPIDSPTSI', 'SPEI_HYPOTHESIS', 'DISPID_SDKEnumValues',
    'DISPID_SRGSetTextSelection', 'SPPHRASE', 'DISPID_SPPId',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCSetAdaptationData',
    'tagSTATSTG', 'DISPID_SVSkip', 'DISPID_SOTCategory',
    'ISequentialStream', 'SVSFParseMask', 'SVP_4',
    'DISPID_SGRAttributes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPAs_NewEnum', 'SVP_11', 'ISpStreamFormatConverter',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechRecognizer',
    'DISPID_SLWLangId', 'SPEI_TTS_BOOKMARK', 'SPEI_RECOGNITION',
    'SAFT48kHz16BitStereo', 'ISpVoice', 'DISPID_SLPsCount',
    'DISPID_SRCCreateResultFromMemory', 'SpMMAudioIn',
    'ISpRecoResult', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSetPropertyString', 'SVP_16',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_22kHzMono',
    'SSFMOpenForRead', 'SPLO_DYNAMIC', 'ISpRecoCategory',
    'ISpeechGrammarRuleStateTransitions', 'SVSFIsFilename',
    'DISPID_SVResume', 'SASRun', 'Speech_StreamPos_Asap',
    'SpeechRecoProfileProperties', 'SPSNoun',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPEEngineConfidence', 'SPAUDIOSTATUS', 'DISPID_SASState',
    'STSF_LocalAppData', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpRecognizer3',
    'ISpeechFileStream', 'SDTReplacement',
    'DISPID_SPIRetainedSizeBytes', 'SRARoot',
    'DISPID_SRGDictationSetState', 'ISpeechWaveFormatEx',
    'SPWORDTYPE', 'SREPrivate', 'SAFT16kHz8BitMono',
    'SAFT8kHz8BitStereo', 'DISPID_SGRClear', 'DISPID_SPCLangId',
    'STCAll', 'DISPID_SPERequiredConfidence', 'SRESoundStart',
    'DISPID_SVStatus', 'DISPID_SRSCurrentStreamPosition',
    'SGDSActive', 'SGDSInactive', 'SVP_6', 'SITooLoud',
    'DISPIDSPTSI_SelectionOffset',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPRuleConfidence',
    'DISPID_SGRSTsCount', 'SDTAudio', 'DISPID_SRGCmdLoadFromResource',
    'SREHypothesis', 'DISPID_SPPsItem', 'SPLEXICONTYPE',
    'SPEI_INTERFERENCE', 'DISPID_SGRSTNextState', 'DISPID_SPAsItem',
    'SpeechMicTraining', 'SPCONTEXTSTATE', 'SGDSActiveUserDelimited',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEInterference',
    'SP_VISEME_14', 'DISPID_SLGetPronunciations', 'SRSActive',
    'DISPID_SRIsShared', 'SASPause', 'DISPID_SpeechAudio',
    'SpMMAudioEnum', 'DISPID_SpeechPhraseElement',
    'SVEEndInputStream', 'DISPID_SVVoice', 'SPEI_RECO_OTHER_CONTEXT',
    'SPXRO_Alternates_SML', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_PRIVATE8', 'eLEXTYPE_VENDORLEXICON',
    'SAFT12kHz8BitMono', 'SREPhraseStart', 'SpeechDiscardType',
    'DISPID_SBSRead', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVGetAudioOutputs', 'ISpeechPhraseElement',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE16',
    'SVP_15', 'SPBINARYGRAMMAR', 'SpeechDictationTopicSpelling',
    'DISPID_SOTMatchesAttributes', 'SRTExtendableParse',
    'SPWF_SRENGINE', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPAUDIOBUFFERINFO', 'ISpRecoContext', 'SAFTGSM610_44kHzMono',
    'SPRULESTATE', 'ISpLexicon', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechLexiconProns', 'ISpRecognizer2', 'SP_VISEME_5',
    'DISPID_SpeechRecoContextEvents', 'SREStreamEnd',
    'SPEI_END_INPUT_STREAM', 'SPEI_MIN_TTS',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTGetDescription', 'DISPID_SPPName',
    'DISPID_SDKEnumKeys', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRCEHypothesis', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechPhraseElements', 'SRERecognition',
    'ISpObjectWithToken', 'DISPID_SpeechPhraseReplacements',
    'ISpeechPhraseAlternates', 'SPCT_COMMAND',
    'DISPID_SRCERecognizerStateChange', 'ISpObjectTokenCategory',
    'ISpPhraseAlt', 'DISPID_SPAStartElementInResult',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechTokenKeyAttributes',
    'SPEI_TTS_PRIVATE', 'SPSSuppressWord', 'DISPID_SpeechRecoResult',
    'Speech_Default_Weight', 'SVSFDefault', 'SAFT11kHz16BitMono',
    'SVP_12', 'STSF_AppData', '_ISpeechVoiceEvents',
    'SAFT48kHz8BitStereo', 'eLEXTYPE_PRIVATE11', 'DISPID_SAVolume',
    'SpeechGrammarTagWildcard', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPIEnginePrivateData', 'SRSEIsSpeaking', 'SGSEnabled',
    'SP_VISEME_6', 'SSTTDictation', 'IInternetSecurityMgrSite',
    'ISpeechObjectTokens', 'STCRemoteServer',
    'SpeechCategoryAudioOut', 'SREAllEvents', 'DISPID_SVEVoiceChange',
    'SINone', 'ISpMMSysAudio', 'DISPID_SRState',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRuleId', 'SAFT16kHz16BitMono',
    'DISPID_SPPsCount', 'SPPS_LMA', 'DISPID_SGRsFindRule',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRRSpeakAudio',
    'DISPID_SPIGrammarId', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechLexicon', 'DISPID_SLPType', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRSTType', 'SPPS_Unknown', 'DISPID_SRRTOffsetFromStart',
    'SPAR_High', 'ISpeechAudioFormat', 'SVP_7',
    'DISPID_SPPEngineConfidence', 'DISPID_SVEViseme',
    'SGRSTTDictation', 'SRERecoOtherContext',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_12', 'DISPID_SAStatus',
    'DISPID_SVSRunningState', '__MIDL_IWinTypes_0009',
    'DISPID_SVAudioOutput', 'DISPID_SRRGetXMLErrorInfo',
    'SAFT8kHz16BitStereo', 'SPEI_RESERVED2',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVEventInterests', 'DISPID_SLWsItem',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRSetPropertyNumber',
    'SAFTADPCM_11kHzMono', 'DISPID_SLPsItem', 'SPPS_Interjection',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGRecoContext',
    'SPRS_ACTIVE_USER_DELIMITED', 'SSFMCreate', 'SRSInactive',
    'DISPID_SPPChildren', 'DISPID_SGRsDynamic', 'SDKLDefaultLocation',
    'ISpPhoneticAlphabetSelection', 'SAFT12kHz16BitMono',
    'DISPID_SGRSTText', 'SPEI_VISEME', 'SBOPause',
    'DISPID_SRGCmdLoadFromMemory', 'SPAO_NONE', 'ISpeechAudioStatus',
    'SPRS_INACTIVE', 'DISPID_SGRAddResource', 'SPSERIALIZEDPHRASE',
    'ISpeechRecoResultTimes', 'SPAS_RUN', 'SAFT8kHz8BitMono',
    'SPPROPERTYINFO', 'DISPID_SDKDeleteKey',
    'ISpeechLexiconPronunciation', 'DISPID_SPARecoResult',
    'DISPID_SPIGetDisplayAttributes', 'SpeechBookmarkOptions',
    'DISPID_SGRSTransitions', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechResourceLoader', 'SpeechDataKeyLocation', 'SVPOver',
    'SAFT24kHz16BitStereo', 'SRAONone', 'DISPID_SGRSTWeight',
    'DISPID_SpeechVoiceStatus', 'SPDATAKEYLOCATION',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVSInputSentencePosition',
    'SAFT24kHz8BitStereo', 'SPSFunction', 'SPEVENTENUM', 'SPWORD',
    'SpeechDisplayAttributes', 'DISPID_SPRs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechBaseStream',
    'DISPID_SRCEPropertyStringChange', 'SAFT22kHz8BitMono',
    'SRADynamic', 'SpeechAddRemoveWord', 'DISPID_SRCERequestUI',
    'SGRSTTTextBuffer', 'SGDSActiveWithAutoPause', 'SPXRO_SML',
    'DISPID_SpeechPhraseProperties', 'eLEXTYPE_PRIVATE18',
    'SpeechAudioState', 'SP_VISEME_15', 'SSSPTRelativeToStart',
    'DISPID_SBSSeek', 'eLEXTYPE_RESERVED10', 'DISPID_SGRsItem',
    'SPCATEGORYTYPE', 'SP_VISEME_9', 'SpStream',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechAudioFormat',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPXMLRESULTOPTIONS',
    'SPTEXTSELECTIONINFO', 'ISpeechMMSysAudio',
    'DISPID_SASCurrentDevicePosition', 'SAFT32kHz16BitMono',
    'SVEPhoneme', 'SVP_19', 'SPSInterjection', 'SPRECORESULTTIMES',
    'SVP_20', 'SpeechPropertyResourceUsage', 'SPDKL_LocalMachine',
    'ISpeechGrammarRuleState', 'Speech_Max_Pron_Length',
    'SPEI_PHRASE_START', 'eLEXTYPE_PRIVATE5', 'SPPHRASEELEMENT',
    'STSF_CommonAppData', 'DISPID_SPRNumberOfElements', 'SPBO_AHEAD',
    'SRAORetainAudio', 'DISPID_SGRSAddWordTransition',
    'SpeechTokenKeyUI', 'SPGRAMMARSTATE', 'DISPID_SVSPhonemeId',
    'ISpRecoGrammar2', 'ISpDataKey', 'SAFT12kHz8BitStereo',
    'SpeechAudioFormatGUIDWave', 'SP_VISEME_0', 'SVP_10',
    'SpeechAudioVolume', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SWFEFormatTag', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SREmulateRecognition', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCRecognizer', 'DISPID_SBSFormat',
    'DISPID_SpeechPhraseAlternate', 'SPAS_STOP', 'SP_VISEME_18',
    'SPPARTOFSPEECH', 'DISPID_SPRuleFirstElement',
    'DISPID_SPISaveToMemory', 'SREFalseRecognition',
    'SpeechRecognizerState', 'DISPID_SRGReset',
    'SpeechPropertyResponseSpeed', 'ISpStream',
    'DISPID_SVIsUISupported', 'SLTUser',
    'SpeechPropertyNormalConfidenceThreshold', 'IEnumSpObjectTokens',
    'SPAS_CLOSED', 'DISPID_SGRsCount', 'SREInterference',
    'eLEXTYPE_PRIVATE3', 'IInternetSecurityManager',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPEDisplayAttributes', 'SDTDisplayText',
    'SPEI_SOUND_START', 'SSFMOpenReadWrite',
    'DISPID_SVSpeakCompleteEvent', 'SVEWordBoundary',
    'DISPID_SGRs_NewEnum', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhraseBuilder', 'SpVoice',
    'DISPID_SRCreateRecoContext', 'tagSPPROPERTYINFO',
    'STCLocalServer', 'SAFTCCITT_ALaw_11kHzMono',
    'SSFMCreateForWrite', 'ISpeechPhraseReplacement',
    'SpeechVisemeType', 'SGRSTTEpsilon', 'SPEI_MAX_TTS',
    'ISpeechRecoResult', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT24kHz16BitMono',
    'SAFTADPCM_44kHzMono', 'SP_VISEME_17',
    'DISPID_SRCEFalseRecognition', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpeechPhraseProperties', 'SAFTCCITT_uLaw_8kHzMono', 'SPSMF_UPS',
    'DISPID_SVEPhoneme', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRRecognizer', 'DISPID_SRAudioInput',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechLexiconWords',
    'ISpeechLexiconWords', 'DISPID_SGRSAddSpecialTransition',
    'SWTAdded', 'ISpAudio', 'DISPID_SOTDataKey',
    'DISPID_SPAPhraseInfo', 'SpeechAudioProperties',
    'DISPID_SRCRetainedAudio', 'SINoSignal', 'SPAUDIOOPTIONS',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPINTERFERENCE_NOSIGNAL',
    'SGSExclusive', 'SPEI_UNDEFINED', 'SPPS_RESERVED2',
    'DISPID_SPIRule', 'SPINTERFERENCE_NOISE', 'SVP_9',
    'SPSHT_Unknown', 'SDTProperty', 'DISPID_SRCERecognition',
    'DISPID_SRRRecoContext', 'DISPID_SpeechLexiconWord',
    'SDKLLocalMachine', 'DISPID_SPEsItem', 'DISPID_SRCESoundEnd',
    'SPSLMA', 'DISPID_SPCIdToPhone', 'SECFEmulateResult',
    'SPPS_Noncontent', 'SPPS_RESERVED4', 'DISPID_SGRsCommitAndSave',
    'ISpeechPhraseRules', 'ISpNotifySink', 'SDA_One_Trailing_Space',
    'ISpeechRecognizer', 'DISPID_SPPValue', 'SVP_18',
    'DISPID_SPRsCount', 'DISPID_SRCVoice', 'SITooQuiet',
    'DISPID_SPRFirstElement', 'SPINTERFERENCE_TOOQUIET',
    'SVEAudioLevel', 'SPCT_SUB_DICTATION', 'SP_VISEME_2',
    'SSTTTextBuffer', 'SRTSMLTimeout', 'SRESoundEnd',
    'SVSFPersistXML', 'DISPID_SPELexicalForm',
    'DISPID_SpeechPhraseRule', 'SPVPRI_OVER', 'SAFT11kHz8BitStereo',
    'SpNullPhoneConverter', 'DISPID_SLWPronunciations', 'SVEBookmark',
    'SP_VISEME_7', 'DISPID_SWFEBitsPerSample', 'SPVOICESTATUS',
    'SPGS_EXCLUSIVE', 'SVEViseme', 'SAFTCCITT_uLaw_11kHzMono',
    'SREStateChange', 'DISPID_SPERetainedSizeBytes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SABIBufferSize',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCEPhraseStart',
    'SpeechLexiconType', 'DISPID_SPPFirstElement',
    'SDKLCurrentConfig', 'DISPID_SDKDeleteValue',
    'ISpeechRecoGrammar', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_APP',
    'DISPID_SASFreeBufferSpace', 'SECFDefault', 'SGSDisabled',
    'SPPS_RESERVED1', 'ISpPhrase', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPCS_DISABLED',
    'DISPID_SLRemovePronunciation', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPIStartTime', 'SPDKL_CurrentConfig',
    'DISPID_SOTIsUISupported', 'ISpGrammarBuilder', 'SVP_1',
    'SpAudioFormat', 'SAFT22kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_SR_PRIVATE',
    'SpeechTokenValueCLSID', 'DISPID_SPPParent',
    'DISPID_SVEEnginePrivate', 'SPEVENT', 'DISPID_SRGId',
    'DISPID_SRCCmdMaxAlternates', 'SINoise', 'SPWORDPRONOUNCEABLE',
    'SPEI_SOUND_END', 'DISPID_SMSGetData', 'SVP_5',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechPhraseProperty',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVPriority',
    'DISPID_SPEDisplayText', 'SGDisplay', 'SpeechRunState',
    'DISPID_SMSADeviceId', 'SAFT12kHz16BitStereo',
    'SpStreamFormatConverter', 'SPEI_PHONEME',
    'DISPID_SGRInitialState', 'SPSNotOverriden',
    'DISPID_SPPConfidence', 'SpMemoryStream',
    'DISPID_SRAudioInputStream', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVVolume',
    'DISPID_SGRSTPropertyId', 'DISPID_SRRTLength', 'SDTAll',
    'SpeechCategoryVoices', 'SPAR_Unknown',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_PRIVATE13', 'SLOStatic',
    'SAFTADPCM_11kHzStereo', 'ISpeechRecoResult2', 'SpeechWordType',
    'SPBO_PAUSE', 'SAFT11kHz16BitStereo', 'SPEI_RESERVED3',
    'DISPID_SVEWord', 'DISPID_SPPs_NewEnum',
    'DISPID_SRGIsPronounceable', 'SP_VISEME_10', 'SPWORDLIST',
    'DISPID_SWFEChannels', 'SpCustomStream', 'SpeechStreamFileMode',
    'SpeechCategoryAppLexicons', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SASetState', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechXMLRecoResult', 'SSTTWildcard', 'SVSFVoiceMask',
    'SPEI_TTS_AUDIO_LEVEL', 'SECFIgnoreCase',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRSAudioStatus',
    'SpSharedRecoContext', 'SPSTREAMFORMATTYPE', 'DISPID_SMSALineId',
    'SPBOOKMARKOPTIONS', 'DISPID_SVRate', 'SPCT_DICTATION',
    'UINT_PTR', 'SVF_Stressed', 'DISPID_SPCPhoneToId',
    '_RemotableHandle', 'SPEVENTSOURCEINFO', 'SDKLCurrentUser',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRRAlternates', 'SPVISEMES',
    'DISPID_SpeechAudioStatus', 'DISPID_SVPause',
    'eLEXTYPE_RESERVED8', 'IEnumString',
    'SpPhoneticAlphabetConverter', 'SpWaveFormatEx',
    'DISPID_SRProfile', 'SRAImport',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFTNonStandardFormat',
    'SPFM_OPEN_READONLY', 'SPCT_SUB_COMMAND', 'SAFT22kHz16BitMono',
    'SVP_21', 'DISPID_SLGetGenerationChange',
    'DISPID_SRCERecognitionForOtherContext',
    'SPWORDPRONUNCIATIONLIST', 'SpeechTokenContext', 'SRTEmulated',
    'SAFTADPCM_22kHzMono', 'ISpeechAudio',
    'DISPID_SVAudioOutputStream', 'DISPID_SPERetainedStreamOffset',
    'SVPAlert', 'DISPID_SABufferInfo',
    'ISpeechTextSelectionInformation', 'Speech_Max_Word_Length',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRSClsidEngine', 'DISPIDSPRG',
    'SAFT48kHz8BitMono', 'DISPID_SpeechObjectToken', 'eLEXTYPE_USER',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPIReplacements',
    'SPBO_NONE', 'SpeechCategoryAudioIn', 'ISpeechPhraseProperty',
    'DISPID_SAEventHandle', 'SpeechRecoContextState',
    'DISPID_SRCEStartStream', 'DISPID_SRGCmdLoadFromObject',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRsAdd',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SDKGetlongValue',
    'eLEXTYPE_MORPHOLOGY', 'IStream', 'SP_VISEME_20',
    'ISpPhoneticAlphabetConverter', 'SpCompressedLexicon',
    'DISPID_SPACommit', 'DISPID_SPEs_NewEnum', 'DISPID_SPEsCount',
    'SPSModifier', 'DISPID_SPIProperties', 'DISPID_SGRSTPropertyName',
    'SGRSTTRule', 'SWTDeleted', 'ISpeechPhraseRule',
    'SpeechCategoryRecognizers', 'DISPID_SpeechObjectTokens',
    'SECFIgnoreWidth', 'SpeechGrammarState', 'DISPID_SPRules_NewEnum',
    'SpeechGrammarWordType', 'SPSEMANTICFORMAT',
    'SpeechEmulationCompareFlags', 'SPWORDPRONUNCIATION',
    'ISpeechRecognizerStatus', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPIAudioSizeBytes', 'SpeechStreamSeekPositionType',
    'SpeechTokenKeyFiles', 'SPFM_NUM_MODES', 'ISpObjectToken',
    'DISPID_SRGetFormat', 'ISpRecoContext2', 'eLEXTYPE_PRIVATE17',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SOTDisplayUI',
    'DISPID_SPIAudioSizeTime', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRSSupportedLanguages', 'SPSVerb', 'SPEI_END_SR_STREAM',
    'eWORDTYPE_DELETED', 'DISPID_SLPPhoneIds', 'ISpeechPhraseInfo',
    'ISpeechPhraseAlternate', 'ISpXMLRecoResult', 'DISPID_SBSWrite',
    'SPEI_RESERVED5', 'DISPID_SLAddPronunciation', 'SITooFast',
    'SpeechFormatType', 'DISPID_SOTId', 'SECNormalConfidence',
    'SpInProcRecoContext', 'DISPID_SpeechPhraseAlternates',
    'ISpNotifySource', 'WAVEFORMATEX',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SWFEAvgBytesPerSec',
    'SGPronounciation', 'SAFTCCITT_uLaw_22kHzStereo',
    'SAFT44kHz16BitStereo', 'DISPID_SGRSTsItem', 'eWORDTYPE_ADDED',
    'SPRS_ACTIVE', 'SGRSTTWord', 'SREStreamStart', 'SLODynamic',
    'SVSFIsXML', 'DISPID_SVGetProfiles', 'ISpeechGrammarRule',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRRAudio', 'ISpPhoneConverter',
    'DISPID_SPRuleNumberOfElements', 'SPDKL_DefaultLocation',
    'ISpeechObjectTokenCategory', 'DISPID_SFSOpen', 'DISPID_SGRName',
    'SAFTCCITT_uLaw_8kHzStereo', 'eLEXTYPE_PRIVATE9', 'SVSFIsNotXML',
    'SFTInput', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRStatus',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE14', 'ISpeechPhoneConverter',
    'ISpeechDataKey', 'DISPID_SOTsItem', 'DISPID_SRCESoundStart',
    'SWPUnknownWordPronounceable', 'DISPID_SVGetVoices',
    'DISPID_SPIEngineId', 'DISPID_SABIMinNotification', 'SPSHT_EMAIL',
    'SDTLexicalForm', 'SVP_2', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVSpeak', 'SRATopLevel', 'DISPID_SWFEExtraData',
    'SPWT_PRONUNCIATION', 'DISPID_SDKSetStringValue',
    'DISPID_SPRText', 'ISpeechLexiconWord', 'DISPID_SpeechFileStream',
    'SAFT8kHz16BitMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechObjectToken', 'SVPNormal', 'DISPID_SpeechBaseStream',
    'SASStop', 'SPGRAMMARWORDTYPE', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTSetId',
    'DISPID_SpeechMemoryStream', 'DISPID_SVGetAudioInputs',
    'SVF_Emphasis', 'DISPID_SLPSymbolic', 'DISPID_SRCCreateGrammar',
    'SpeechVisemeFeature', 'SPEI_WORD_BOUNDARY',
    'SDA_Two_Trailing_Spaces', 'SAFT16kHz16BitStereo',
    'ISpeechRecoResultDispatch', 'SPVPRI_ALERT',
    'DISPID_SPEPronunciation', 'DISPID_SLWWord', 'STCInprocHandler',
    'SECFNoSpecialChars', 'DISPID_SRRDiscardResultInfo',
    'ISpStreamFormat', 'SAFT32kHz8BitMono', 'SVF_None',
    'DISPID_SWFESamplesPerSec', 'SpObjectTokenCategory',
    'SPSHT_NotOverriden', 'DISPID_SGRId', '_SPAUDIOSTATE',
    'DISPID_SRCEEndStream', 'SPCT_SLEEP', 'SVSFUnusedFlags',
    'SREAdaptation', 'SP_VISEME_1', 'DISPID_SGRSTPropertyValue',
    'SPPHRASEREPLACEMENT', 'DISPID_SPRsItem', 'SPINTERFERENCE_NONE',
    'SPAS_PAUSE', 'SP_VISEME_21', 'SAFTADPCM_22kHzStereo',
    'DISPID_SOTRemove', 'SDTAlternates', 'SPDKL_CurrentUser',
    'DISPID_SRGDictationLoad', 'SAFT44kHz16BitMono', 'SPSUnknown',
    'SPPS_Modifier', 'DISPID_SAFGetWaveFormatEx',
    'SPSHORTCUTPAIRLIST', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SFSClose', 'DISPID_SPILanguageId', 'SpPhraseInfoBuilder',
    'SpMMAudioOut', 'DISPID_SVSLastBookmarkId', 'SVEPrivate',
    'DISPID_SPEAudioSizeTime', 'SPAUDIOSTATE', 'SpeechRuleState',
    'SpeechPropertyAdaptationOn', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCRequestedUIType', 'DISPID_SVESentenceBoundary',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSRule',
    'SAFT16kHz8BitStereo', 'SAFT32kHz8BitStereo',
    'SAFT22kHz8BitStereo', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechCustomStream', 'SpeechWordPronounceable',
    'SpSharedRecognizer', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCEventInterests'
]

_check_version('1.1.14', 1668287535.090009)
